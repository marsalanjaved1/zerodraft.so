...
export const ColorSelector = ({ isOpen, setIsOpen }: ColorSelectorProps) => {
        ...
        <div className="relative">
            ...
            {isOpen && (
                <section className="fixed top-full z-[99999] mt-1 flex w-48 flex-col overflow-hidden rounded border border-stone-200 bg-white p-1 shadow-xl animate-in fade-in slide-in-from-top-1">
                    <div className="my-1 px-2 text-xs font-semibold text-stone-500">
                        Color
                    </div>
                    ...
                    <div className="mb-1 mt-2 px-2 text-xs font-semibold text-stone-500">
                        Background
                    </div>
