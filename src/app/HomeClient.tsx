    ...
    return (
        <div className="flex min-h-screen flex-col overflow-x-hidden bg-white text-[#111318] selection:bg-primary/20">
            ...
            <main className="flex-1">
                ...
                <section className="mx-auto max-w-7xl px-6 py-20 text-center lg:px-10 lg:py-32">
                    <div className="mx-auto max-w-4xl flex flex-col items-center">
                        ...
                        <h1 className="serif-headline text-5xl font-semibold leading-[1.1] tracking-tight text-[#111318] sm:text-7xl lg:text-8xl">
                            The AI Agent for<br />Product Managers
                        </h1>
                        <p className="mt-8 max-w-2xl text-lg leading-relaxed text-[#616f89] sm:text-xl">
                            ZeroDraft reads your Zoom calls, Slack threads, and Jira tickets — then drafts updates, tickets, and specs with real customer quotes. In minutes, not hours.
                        </p>

                        {/* Stat bar */}
                        <div className="mt-8 flex flex-wrap justify-center gap-6 sm:gap-10">
                            <div className="flex flex-col items-center">
                                <span className="text-2xl font-bold text-[#111318] sm:text-3xl">30–50%</span>
                                <span className="text-xs text-[#616f89] mt-1">of PM time on docs</span>
                            </div>
                            <div className="w-px h-12 bg-[#e5e7eb] hidden sm:block"></div>
                            <div className="flex flex-col items-center">
                                <span className="text-2xl font-bold text-[#111318] sm:text-3xl">6+</span>
                                <span className="text-xs text-[#616f89] mt-1">tools juggled daily</span>
                            </div>
                            <div className="w-px h-12 bg-[#e5e7eb] hidden sm:block"></div>
                            <div className="flex flex-col items-center">
                                <span className="text-2xl font-bold text-[#111318] sm:text-3xl">40%</span>
                                <span className="text-xs text-[#616f89] mt-1">productivity lost to context switching</span>
                            </div>
                        </div>
                    ...
                    {/* Product Preview — Single PM Demo (no tabs) */}
                        ...
                        <div className="overflow-hidden rounded-xl border border-[#dbdfe6] bg-[#fcfcfd] p-2 shadow-2xl">
                            <div className="rounded-lg border border-[#dbdfe6] bg-white shadow-inner overflow-hidden">
                                <div className="flex items-center gap-2 border-b border-[#dbdfe6] bg-[#f8f9fa] px-4 py-3">
                                    ...
                                    <div className="mx-auto text-xs font-medium text-[#616f89]">SSO_PRD.md — zerodraft.so</div>
                                </div>
                                {/* Agent Animation Component — PM only */}
                                <div className="h-[600px] w-full bg-white relative">
                                    <AgentAnimation activeScenarioId="pm" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="mx-auto max-w-5xl px-6 py-24 lg:px-10" id="story">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div className="prose prose-lg text-[#616f89] leading-relaxed">
                            ...
                            <p className="mb-6">
                                Then I watched our PM spend 3 hours copy-pasting Slack threads into a Google Doc to write a single PRD. She had 14 browser tabs open — Jira, Confluence, Slack, customer feedback spreadsheets — manually stitching context together.
                            </p>
                            <p className="mb-6 font-bold text-[#111318]">
                                Engineers got Cursor. PMs got... nothing.
                            </p>
                            <p className="mb-6">
                                I built ZeroDraft to bridge that gap. An agentic editor that connects to the tools PMs already use, pulls context automatically, and writes specs directly — with full track changes, not a chat window.
                            </p>
                        ...
                        <div className="relative">
                            <div className="aspect-[4/5] relative rounded-2xl overflow-hidden shadow-2xl rotate-3 hover:rotate-0 transition-all duration-500">
                                ...
                                <div className="absolute bottom-6 left-6 right-6 text-white">
                                    <div className="text-lg font-bold serif-headline">&quot;It&apos;s Cursor, but for PMs.&quot;</div>
                                </div>
                            </div>
                ...
                {/* PM-Specific Feature Grid */}
                <section className="bg-[#fcfcfd] border-y border-[#f0f2f4] py-24" id="features">
                    <div className="mx-auto max-w-7xl px-6 lg:px-10">
                        <div className="text-center mb-16">
                            <h2 className="serif-headline text-3xl font-bold text-[#111318] sm:text-4xl">Built for how PMs actually work.</h2>
                            <p className="mt-4 text-lg text-[#616f89] max-w-2xl mx-auto">Not another chatbot. A workspace that understands your stack.</p>
                        </div>
                        <div className="grid gap-12 md:grid-cols-3">
                            <div className="flex flex-col gap-4">
                                ...
                                <h3 className="text-xl font-bold text-[#111318]">Pulls Context From Your Stack</h3>
                                <p className="text-[#616f89] leading-relaxed">
                                    Connects to Slack, Jira, and Confluence. Reads the threads, tickets, and docs so you don&apos;t have to copy-paste across 6 tabs.
                                </p>
                                <div className="flex gap-2 mt-2 flex-wrap">
                                    ...
                                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-[#172B4D]/5 text-[#172B4D] text-xs font-medium">
                                        Confluence
                                    </span>
                                </div>
                            </div>
                            <div className="flex flex-col gap-4">
                                ...
                                <h3 className="text-xl font-bold text-[#111318]">Writes Specs, Not Chat Responses</h3>
                                <p className="text-[#616f89] leading-relaxed">
                    ...
                    <div className="rounded-3xl bg-[#111318] p-12 lg:p-24 overflow-hidden relative">
                        ...
                        <div className="relative z-10">
                            <h2 className="serif-headline text-4xl font-bold text-white sm:text-5xl lg:text-6xl">
                                Write your next PRD in 10 minutes.
                            </h2>
                            <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-400">Stop gathering context. Start shipping product.</p>
                            <div className="mt-10 flex flex-wrap justify-center gap-4">
                                {user ? (
                                    <Link
                                        href="/dashboard"
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-10">
                    <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
                        <div className="flex flex-col gap-4">
                            ...
                            <p className="text-sm text-[#616f89]">Open Source. Web Based. Built for Product Managers.</p>
                        </div>
                    </div>
